...
private let nikiShellModeEnabled = false
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        DistributedNotificationCenter.default().addObserver(
            self,
            selector: #selector(openSettingsFromDesktopBridge),
            name: Notification.Name("com.niki.notch.openSettings"),
            object: nil
        )

        DistributedNotificationCenter.default().addObserver(
            self,
            selector: #selector(restartFromDesktopBridge),
            name: Notification.Name("com.niki.notch.restart"),
            object: nil
        )

        DistributedNotificationCenter.default().addObserver(
            self,
            selector: #selector(openFromDesktopBridge),
            name: Notification.Name("com.niki.notch.open"),
            object: nil
        )

        DistributedNotificationCenter.default().addObserver(
            self,
            selector: #selector(closeFromDesktopBridge),
            name: Notification.Name("com.niki.notch.close"),
            object: nil
        )
    ...
    @objc
    private func openSettingsFromDesktopBridge() {
        DispatchQueue.main.async {
    ...
    @objc
    private func restartFromDesktopBridge() {
        DispatchQueue.main.async {
    ...
    @objc
    private func openFromDesktopBridge() {
        DispatchQueue.main.async {
            if Defaults[.showOnAllDisplays] {
    ...
    @objc
    private func closeFromDesktopBridge() {
        DispatchQueue.main.async {
            self.closeNotchTask?.cancel()
            self.closeNotchTask = nil
            if Defaults[.showOnAllDisplays] {
