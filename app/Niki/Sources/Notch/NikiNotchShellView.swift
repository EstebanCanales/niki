...
private let shellMessages: [NikiShellMessage] = [
    .init(role: "Agent", text: "I can help you organize work, review context, and keep the desktop flow focused.", time: "14:36"),
    .init(role: "You", text: "Show me the new mac shell.", time: "14:37"),
    .init(role: "Agent", text: "This first pass keeps the orb, dock, and a single chat sidebar without runtime logic.", time: "14:37"),
]

struct NikiNotchShellView: View {
        ...
        VStack(spacing: 0) {
            ...
            VStack(spacing: 12) {
                HStack(spacing: 10) {
                    ...
                    TextField("Ask anything", text: $composerText)
                        .textFieldStyle(.plain)
                        .font(.system(size: 15, weight: .medium))
                        .foregroundStyle(.white.opacity(0.9))
