...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "com.niki.NikiXPCHelper"
    
    private var remoteService: RemoteXPCService<NikiXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<NikiXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<NikiXPCHelperProtocol>(
            connection: conn,
            remoteInterface: NikiXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<NikiXPCHelperProtocol>? {
        remoteService
    }
