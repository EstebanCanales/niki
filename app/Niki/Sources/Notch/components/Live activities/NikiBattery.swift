...
struct BatteryView: View {
    ...
    var body: some View {
        ZStack(alignment: .leading) {
            ...
            if showsPowerOrb && (isForNotification || Defaults[.showPowerStatusIcons]) {
                ZStack {
                    Circle()
                        .fill(
                            RadialGradient(
                                colors: [
                                    ...
                                    (isCharging ? Color.green : Color.blue).opacity(0.9),
                                    (isCharging ? Color.green : Color.blue).opacity(0.08)
                                ],
                                center: .center,
                                startRadius: 1,
                                endRadius: 10
                        ...
                        .shadow(
                            color: (isCharging ? Color.green : Color.blue).opacity(0.45),
                            radius: 4,
                            x: 0,
                            y: 0
                        )
